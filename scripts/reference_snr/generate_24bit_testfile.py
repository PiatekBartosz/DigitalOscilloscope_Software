...
filename = 'WAVtestsignals/signal' + str(round(As/1e6,2)) + 'M_noise' + str(round(An)) + 'int32_24bit.wav'
...
filename = 'WAVtestsignals/signal' + str(round(As/1e6,2)) + 'M_noise' + str(round(An)) + 'float32_24bit.wav'
